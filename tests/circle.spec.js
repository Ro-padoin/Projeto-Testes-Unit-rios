...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  ...
  it('Teste que a função retorna, num objeto, os dados corretos de um círculo de raio 3.', () => {
    const entradaFuncao = circle(3);
    expect(entradaFuncao.radius).toEqual(3);
    expect(entradaFuncao.area).toBeCloseTo(28.26, 2);
    expect(entradaFuncao.circumference).toEqual(18.84);
  });
});
