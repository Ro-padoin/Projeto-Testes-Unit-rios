...
describe('2 - Implemente os casos de teste para a função `numbers`', () => {
  it('Teste se a função recebe [1, 2, 3, 4, 5] e retorna true', () => {
    expect(numbers([1, 2, 3, 4, 5])).toEqual(true);
  });
  it('Teste se a função recebe [1, 2, "3", 4, 5] e retorna false', () => {
    expect(numbers([1, 2, '3', 4, 5])).toEqual(false);
  });
  it('Teste se a função recebe [1, "a", 3] e retorna false', () => {
    expect(numbers([1, "a", 3])).toEqual(false);
  });
  it('Teste se a função recebe [" "] e retorna false', () => {
